...
Note: De client is geen server en om hem op te starten moeten we een Windows 10.iso gebruiken inplaats van een Windows Server 2016 iso.
...
1) Hernoem de computer en join het domein.
  * Ga naar de *computereigenschappen* en 
