#Set hostname to 'ServerSQLEX'
write-host "Changing hostname and joining the 'keanys.gent' domain"
#netdom renamecomputer %computername% /newname:ServerSQLEX
#Rename-Computer -NewName ServerSQLEX
Add-Computer -DomainName "keanys.gent" -NewName "ServerSQLEX" -Credential (Get-Credential keanys\administrator) -Force

write-host "Setting timezone to Romance Standard Time (Brussels)"
Set-TimeZone -Name "Romance Standard Time"

#Set static ip address.
write-host "Setting static ip to '192.168.1.3'"
#New-NetIPAddress -InterfaceIndex 4 -IPAddress 192.168.1.3 -PrefixLength 24
